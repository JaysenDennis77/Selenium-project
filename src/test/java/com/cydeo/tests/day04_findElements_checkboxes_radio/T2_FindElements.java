...
public class T2_FindElements {
    ...
    public static void main(String[] args) {
       ...
       //WebElement link1 = driver.findElement(By.xpath("//a[@class='nav-link']"));    good effort but his way is better
       //WebElement link2 = driver.findElement(By.cssSelector("a[target='_blank']"));
